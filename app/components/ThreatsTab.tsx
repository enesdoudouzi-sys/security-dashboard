          ...
          >
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex justify-between">
                ...
                <span className={`px-2 py-0.5 rounded border text-xs font-bold ${STATUS_STYLES[t.status] ?? "text-gray-400 border-gray-600"}`}>
            ...
            <div className="pt-1 border-t border-gray-800 flex gap-2">
              <button className="text-xs text-gray-500 hover:text-red-400 transition-colors cursor-pointer">
                Block IOC
              </button>
              <span className="text-gray-700">|</span>
              <button className="text-xs text-gray-500 hover:text-yellow-400 transition-colors cursor-pointer">
                Investigate
              </button>
              <span className="text-gray-700">|</span>
              <button className="text-xs text-gray-500 hover:text-green-400 transition-colors cursor-pointer">
                Mark Resolved
              </button>
            </div>
          </div>
